...
export class ProductService {
  ...
  constructor() {
    ...
    this.reviews_p04=[{id:'1',reviewer_name:"Anjei Kovalsky",date:"01 AUG 2019, 11:30 AM",content:"Overall Good,but too much expensive",rating:3}];
     ...
     {id:'p05',category:'headphones',name:'Creativa Pro Headphones',price:700,photo:'product05.png',description:"Headphones are small speakers that can be worn in or around your ears. ... Smaller headphones, often called earbuds or earphones, are placed inside the outer part of your ear canal. Like speakers, headphones contain transducers that convert an audio signal into sound waves",reviews:[]},
     {id:'p06',category:'laptop',name:'Vaios 15 inch Laptop',price:1000,photo:'product06.png',description:"Laptop Computer. A laptop computer is a portable personal computer powered by a battery, or an AC cord plugged into an electrical outlet, which is also used to charge the battery. ... A laptop also has a thin display screen that is attached and can be folded flat for transport",reviews:[]},
     {id:'p07',category:'smartphone',name:'SuperNova Deluxe Smartphone',price:160,photo:'product07.png',description:"A smartphone is a mobile phone with highly advanced features. A typical smartphone has a high-resolution touch screen display, WiFi connectivity, Web browsing capabilities, and the ability to accept sophisticated applications.",reviews:[]},
     {id:'p08',category:'laptop',name:'SuperNova 14 inch Laptop',price:250,photo:'product08.png',description:"Laptop Computer. A laptop computer is a portable personal computer powered by a battery, or an AC cord plugged into an electrical outlet, which is also used to charge the battery. ... A laptop also has a thin display screen that is attached and can be folded flat for transport",reviews:[]},
     {id:'p09',category:'camera',name:'DigiCam Pro Move L234',price:150,photo:'product09.png',description:"A digital camera is a similar to a traditional film-based camera, but it captures images digitally. When you take a picture with a digital camera, the image is recorded by a sensor, called a 'charged coupled device' or CCD. ... Some digital cameras have built-in memory, but most use an SD or Compact Flash card",reviews:[]}
     ];
